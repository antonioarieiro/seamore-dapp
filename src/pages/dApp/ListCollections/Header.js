...
export default function NftListHeader() {
  const { setOpenModal, openModal, disconnect } = React.useContext(SeamoreContext);
              ...
              </div>
              {
                account ?
                  <div
                    ...
                    className=" bg-[#14142B] w-[183px] h-[48px] flex items-center mr-2 justify-between ml-[72px] cursor-pointer"
                  >
