...
export default function SelectedNftInfos() {
  ...
  const { collectionSet } = React.useContext(SeamoreContext);
  console.log(collectionSet)
  return (
    <>
   {
     collectionSet &&
     <div className="body  bg-[#14142B] min-w-[1380px] h-full cursor-default details">
     <div className="selected-nft mt-[40px] ml-9 mr-10 flex items-center justify-around">
       <div className='flex items-center'>
         <img src={collectionSet.image_url} alt="" className="w-[72px] h-[72px] rounded-full m-[24px]" />
         <div className="name-and-owner flex flex-col">
           <p className="mb-2 hover:border-b-2 border-blue-500"> {collectionSet.name}</p>
           <span className="w-[180px] flex">
             <span className="truncate w-[160px]">
              {collectionSet.payout_address}
             </span>
             <span>
         ...
         <tbody className="">
           <tr className="body-table items-center">
             ...
             <span className="flex flex-col items-center mr-1 ">
               ...
               <span>
               {collectionSet.stats.floor_price}
               </span>
             </div>
             </th>
             ...
             <div className="flex-col items-center vol-24 mt-4">
                 <div className="flex items-center">
                   ...
                   <p className="hover:border-b-2 border-blue-500">
                     {collectionSet.stats.one_day_volume}
                   </p>
                 </div>
                 <div className="flex items-center">
                   <span className="mr-2">
             ...
             <th className=" px-6 text-white">
               <div className="flex-col items-center vol-7 mt-4">
                 <div className="flex items-center">
                   ...
                   <p className="hover:border-b-2 border-blue-500">
                   {collectionSet.stats.seven_day_volume}
                   </p>
                 </div>
                 <div className="flex items-center">
                   <span className="mr-2">
