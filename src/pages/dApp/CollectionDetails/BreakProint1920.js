...
import './style.scss';
export default function BreakMaxSize() {
      ...
      <div className="2xl:w-8/12 chart flex flex-col">
          ...
          <div className="flex  w-full items-center justify-between h-[96px]">
            ...
            <div className="flex items-center mr-[34px]">
              ...
              filterOptions.map((val, index) => {
                ...
                className=
                {
                  time === val ? 'filter-trade-options ml-12 px-[20px] py-[12px] bg-[#4E4B66] cursor-pointer' 
                  : 'cursor-pointer filter-trade-options ml-12 p-[6px] text-[#6E7191]'}
                >
                  {val}</span>
              })
              }
        ...
        <div className="mt-[32px] flex justify-between items-center">
          ...
          <div className="h-[56px] bg-[#262338] flex items-center">
            ...
            <div className="mr-4">
              {
              traits_time.map((val,index) => {
                <span 
                key={index}
                onClick={() => { setTraitTime(val) }} 
                className={
                  traitTime === val ? 'filter-trade-options ml-[28px] p-[6px] bg-[#4E4B66] cursor-pointer' 
                : 'cursor-pointer filter-trade-options ml-[28px] p-[6px] text-[#6E7191]'
                }>
                  {val}
                  </span>
              })
        ...
        <div className="mt-[24px] flex w-full h-[60px] bg-[#262338]">
          <div className="flex h-[56px] items-center justify-between w-full">
            ...
            <div className="mr-[16px]">
              Time:
            {
            floor_price.map((val, index) => {
<span
key={index}
onClick={() => { setFloor(val) }} 
className={
  floor === val ? 'filter-trade-options ml-12 px-[20px] py-[12px] bg-[#4E4B66] cursor-pointer' 
  : 'cursor-pointer filter-trade-options ml-12 p-[6px] text-[#6E7191]'
  }
  ...
  {val}</span>
      ...
      <div className="ml-[32px]  listing 2xl:w-4/12 flex flex-col">
        <div>
          ...
          <div>
            <div className="flex justify-between items-center w-full mt-10 bg-[#262338] h-[56px]">
            ...
            <div className="flex flex-col justify-between items-end">
              ...
              <div className="h-[56px] mt-[51px] bg-[#262338] flex items-center">
                ...
                <div className="mr-4">
                  {traits_time.map((val, index) => (<span key={val} onClick={() => { setTraitTime(val) }} className={traitTime === val ? 'filter-trade-options ml-[28px] p-[6px] bg-[#4E4B66] cursor-pointer' : 'cursor-pointer filter-trade-options ml-[28px] p-[6px] text-[#6E7191]'}>{val}</span>))}
                </div>
              ...
              <div className="mt-[24px] h-[404px] bg-[#262338] w-full mb-10">
                dale
              </div>
            </div>
          </div>
