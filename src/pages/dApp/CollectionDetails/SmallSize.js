...
import FlorPriceAndAverageChart from './Charts/FloorPriceAndAverageChart';
import 'chartkick/chart.js';
import './style.scss'
import HyperTrendsCharts from './Charts/HyperTrendsCharts';
              ...
              <div className="flex  w-full items-center justify-between h-[96px]">
                ...
                <div className="flex items-center mr-[34px]">
                  ...
                  {filterOptions.map((val, index) => (
                    <span key={index} onClick={() => { setTime(val) }} className={time === val ? 'filter-trade-options ml-12 px-[20px] py-[12px] bg-[#4E4B66] cursor-pointer' : 'cursor-pointer filter-trade-options ml-12 p-[6px] text-[#6E7191]'}>{val}</span>
                  ))}
                </div>
              </div>
            </div>
              ...
              <div className="w-7/12 flex flex-col items-center">
                <div className="w-full  flex justify-between items-center">
                  ...
                  <div className="h-[56px] bg-[#262338] flex items-center">
                    ...
                    <div className="mr-4">
                      {traits_time.map((val, index) => (<span key={index} onClick={() => { setTraitTime(val) }} className={traitTime === val ? 'filter-trade-options ml-[28px] p-[6px] bg-[#4E4B66] cursor-pointer' : 'cursor-pointer filter-trade-options ml-[28px] p-[6px] text-[#6E7191]'}>{val}</span>))}
                    </div>
              ...
              <div className="mt-[24px] flex w-full h-[60px] bg-[#262338]">
                <div className="flex h-[56px] items-center justify-between w-full">
                  ...
                  <div className="mr-[30px]">
                    Time:
                    {uv.map((val, index) => (<span key={index} onClick={() => { setFloor(val) }} className={floor === val ? 'filter-trade-options ml-8 px-[20px] py-[12px] bg-[#4E4B66] cursor-pointer' : 'cursor-pointer filter-trade-options ml-8 p-[6px] text-[#6E7191]'}>{val}</span>))}
                  </div>
                </div>
              </div>
                ...
                <div className="h-[404px] flex w-full">
                  <div className="w-8/12">
                    <div className="mt-[68px]">
                      <FlorPriceAndAverageChart />
                    </div>
                  </div>
                  <div className="flex flex-col items-center w-full ml-[50px]  border-l border-gray-700">
                    <div className="flex w-full flex-col items-center border-b border-gray-700">
                      <div className="last_flor h-[40px] flex flex-col items-center bg-[#2f2c48] mt-[28px]">
                        <span className="flex justify-center items-center w-full h-full">
                          <Icon name='trending_up' size='xl' color='purple' />
                        </span>
                      </div>
                      <div className="flex flex-col items-center mt-[8px]">
                        <p className="w-full text-[#6E7191] text-center">
                          Last highest floor price 24H
                        </p>
                        ...
                        <div className="flor_last_24h flex items-center justify-center mb-[24px] mt-[13px]">
                          <span className="mr-[9px]">
                            <Icon name='north_east' size='sm' color='green' />
                          </span>
                          <p>12,02% IN THE LAST 24 HOURS</p>
                        </div>
                      </div>
                    </div>
                    <div className="flex w-full flex-col items-center">
                      ...
                      <div className="flex flex-col items-center mt-[8px] ">
                        <span className="w-full text-[#6E7191]">
                          Last highest average sparice 24H
                        </span>
                        <div className="flex items-center mt-[13px]">
                          <span className="flex flex-col items-center ">
                            <svg className="mb-1" width="12" height="2" viewBox="0 0 12 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="last_average flex items-center justify-center mb-[24px] mt-[13px]">
                          <span className="mr-[9px]">
                            <Icon name='call_received' size='sm' color='red' />
                          </span>
                          <p>1,29% IN THE LAST 24 HOURS</p>
                        </div>
                      </div>
                    </div>
                  </div>
