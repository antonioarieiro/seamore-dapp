...
import CollectionHeader from './pages/dApp/ListCollections/Header';
...
function Main() {
  ...
  return (
    <>
      <Modal />
      <TraitFilters />
      <div className={openModal && !account  ? "min-w-1920 absolute w-full h-full overflow-hidden main" : "min-w-1920 min-w-full absolute w-full h-full overflow-hidden overflow-y-auto"}>
        <Header />
        <CollectionHeader />
        <Routes>
